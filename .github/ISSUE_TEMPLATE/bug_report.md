...
**CHECKLIST**
- [ ] I have read the [issue reporting guidelines](https://github.com/dpa99c/cordova-plugin-firebasex-config#reporting-issues)
...
- [ ] I have read [the documentation](https://github.com/dpa99c/cordova-plugin-firebasex-config) thoroughly and it does not help solve my issue.
