...
function updatePackageSwiftVersion(projectRoot, newVersion) {
    ...
    packagePaths.forEach(function(packagePath) {
        ...
        console.log("[FirebasexConfig] Firebase SDK version set to v" + newVersion + " in " + packagePath);
    });
}
...
module.exports = function(context) {
    ...
    if (!pluginVariables["IOS_FIREBASE_SDK_VERSION"]){
        console.warn("[FirebasexConfig] IOS_FIREBASE_SDK_VERSION variable not set. Skipping iOS dependency version update.");
        return;
    }
